...
public class MainActivity extends Activity implements MapEventsReceiver
{
    ...
    protected void onCreate(Bundle savedInstanceState)
	{
        ...
        try
		{
			countryBoundaries = CountryBoundariesFactory.createCountryBoundaries(
					getAssets().open("boundaries.osm"),
					getAssets().open("bitmap.png"),
					getAssets().open("bitmapIndices.json")
			);
		} catch (IOException e)
		{
    ...
    public boolean singleTapConfirmedHelper(GeoPoint p)
	{
		...
		List<String> isoCodes = countryBoundaries.getIsoCodes(p.getLongitude(), p.getLatitude());
