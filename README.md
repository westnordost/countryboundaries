...
Add [`de.westnordost:countryboundaries:1.1`](https://maven-repository.com/artifact/de.westnordost/countryboundaries/1.1) as a Maven dependency or download the jar from there.
