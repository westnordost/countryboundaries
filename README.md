...
Add [`de.westnordost:countryboundaries:1.4`](https://maven-repository.com/artifact/de.westnordost/countryboundaries/1.4) as a Maven dependency or download the jar from there.
