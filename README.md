...
Add [`de.westnordost:countryboundaries:1.3`](https://maven-repository.com/artifact/de.westnordost/countryboundaries/1.3) as a Maven dependency or download the jar from there.
